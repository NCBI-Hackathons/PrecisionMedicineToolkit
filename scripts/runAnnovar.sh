...
perl ${ANNOSCRIPT_QUICK} ${InputVCF} ${ANNODIR}/humandb/ -buildver ${GENOMEBUILD} -out ${OUTDIR}/pmtannovar${DateString} -remove -protocol refGene,exac03,avsnp150,clinvar_20170905 -operation g,f,f,f -nastring . -polish -vcfinput
